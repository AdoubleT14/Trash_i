document.addEventListener('DOMContentLoaded', function () {
    // --- Configuration ---
    const API_ENDPOINT = '/backend/predict'; 
    ...
    const wasteDetails = {
        ...
        'unknow': {
            dos: ["ตรวจสอบให้แน่ใจว่ารูปภาพที่ถ่ายคือขยะ", "ลองถ่ายภาพจากมุมอื่นเพื่อให้เห็นวัตถุชัดเจนขึ้น"],
            donts: ["ไม่ควรทิ้งวัตถุที่ไม่ใช่ขยะลงในถังขยะ"],
            fact: "การแยกสิ่งที่ไม่ใช่ขยะออกจากกระบวนการรีไซเคิล ช่วยลดการปนเปื้อนและเพิ่มประสิทธิภาพให้ระบบได้มหาศาล"
        },
        'Other': {
            dos: ["นำไปทิ้งในถังสำหรับขยะทั่วไป หรือถังขยะอันตรายหากไม่แน่ใจ", "ลองตรวจสอบข้อมูลบนบรรจุภัณฑ์ (ถ้ามี)"],
            donts: ["ไม่ควรทิ้งลงในถังรีไซเคิลทันที เพราะอาจทำให้วัสดุรีไซเคิลอื่นปนเปื้อนได้"],
            fact: "ขยะบางชนิด เช่น บรรจุภัณฑ์ที่มีวัสดุหลายประเภทผสมกัน (เช่น ซองขนม) มักจะถูกจัดเป็นขยะทั่วไปเพราะรีไซเคิลได้ยาก"
        }
    };
